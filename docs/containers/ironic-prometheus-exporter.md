...
The `ironic-prometheus-exporter` image is built from [ContainerFiles/ironic-prometheus-exporter](https://github.com/rackerlabs/genestack-images/blob/main/ContainerFiles/ironic-prometheus-exporter). Security patches are applied by [scripts/ironic-cve-patching.sh](https://github.com/rackerlabs/genestack-images/blob/main/scripts/ironic-cve-patching.sh).
...
??? example "ContainerFile used for the build"
    ...
    ``` docker
    --8<-- "ContainerFiles/ironic-prometheus-exporter"
    ```
...
The container image is available on [Github Container Registry](https://github.com/rackerlabs/genestack-images/pkgs/container/genestack-images%2Fironic-prometheus-exporter).
